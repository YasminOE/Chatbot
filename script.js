...
let userMessage;
const API_KEY = "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";
const inputInitHeight = chatInput.scrollHeight;

const createChatLi = (message, className) =>{
  // Create a chat <li> element w/ passed message and className
...
chatInput.addEventListener("keydown", (e)=> {
  // If Enter key is pressed without Sift key and the window 
  // width is grater than 900px, handle the chat
